...
!(function () {
    ...
    jQuery.extend(!0, t, {
        ...
        playVideo: function (o, n) {
            switch (
                (clearTimeout(o.data("videoplaywait")), o.data("videotype"))
            ) {
                case "youtube":
        ...
        manageVideoLayer: function (o, r) {
            ...
            switch ((o.data("videotype", w), b)) {
                case "html5":
                    ...
                    void 0 != c &&
                        ...
                        (k =
                            k + '<source src="' + c + '" type="video/webm" />'),
                        void 0 != u &&
                            (k =
                                k +
                                '<source src="' +
                    ...
                    ("true" === m || m === !0) &&
                        ...
                        o.append(k),
                        ((a && 1 == o.data("disablevideoonmobile")) ||
                            t.isIE(8)) &&
                            o.find("video").remove(),
            ...
            var I =
                (1 != a &&
                    ...
                    "on" != o.data("posteronmobile")) ||
                a;
            void 0 != o.data("videoposter") &&
            o.data("videoposter").length > 2 &&
            I
                ...
                1 == o.data("bgvideo") &&
                    punchgs.TweenLite.set(o.find("video, iframe"), {
                        autoAlpha: 0,
                    });
        },
    });
                ...
                switch (i.data("videotype")) {
                    ...
                    case "vimeo":
                        for (
                            ...
                            g[decodeURIComponent(m[1])] = decodeURIComponent(
                                m[2]
                            );
                        h =
                            void 0 != g.player_id
