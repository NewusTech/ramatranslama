...
function cws_touch_events_fix() {
    if (is_mobile_device()) {
        ...
        jQuery(".work-filter ul.magic-line li a").on(
            "mouseenter",
            function (e) {
                e.preventDefault();
                jQuery(this).trigger("click");
...
function init_twitter_carusel() {
    if ($(".twitter-1").length) {
        ...
        $(".twitter-1.full-screen .tweet_list").addClass(
            "carousel-pag main-color"
        );
        ...
        function () {
            ...
            if (nav_container.hasClass(cls)) {
                nav.stop().animate(
                    {
                        "margin-top":
                            window.mobile_nav.animation_params.vertical_start +
                            "px",
                        opacity: 0,
                    },
                ...
                nav.stop().animate(
                    {
                        "margin-top":
                            window.mobile_nav.animation_params.vertical_end +
                            "px",
                        opacity: 1,
                    },
                    window.mobile_nav.animation_params.speed
    ...
    jQuery("header nav .inner-nav.mobile_nav .button_open").on(
        ...
        function (e) {
            ...
            current_nav_level.animate(
                {
                    right:
                        window.mobile_nav.animation_params.horizontal_end +
                        "px",
                    opacity: 0,
                },
                window.mobile_nav.animation_params.speed,
                function () {
                    ...
                    next_nav_level.animate(
                        {
                            right:
                                window.mobile_nav.animation_params
                                    .horizontal_start + "px",
                            opacity: 1,
                        },
                        window.mobile_nav.animation_params.speed
...
function cws_page_focus() {
    ...
    window.addEventListener("blur", function () {
        document
            .getElementsByTagName("html")[0]
            .removeAttribute("data-focus-chek");
    });
}
...
function magicline_init() {
    ...
    if (!$(".inner-nav").hasClass("mobile_nav")) {
        ...
        $("header .magic-line-main").append(
            "<li class='magic-line-main-li'></li>"
        );
...
function search_form_click() {
    $(".tours-tab-btn").each(function () {
        $(this).on("click", function () {
            ...
            var contH = $(
                ".search-tours-wrap .tours-container.active"
            ).outerHeight();
            $(".search-tours-content").css({ height: +contH + "px" });
        });
    });
