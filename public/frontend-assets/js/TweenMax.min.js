        ...
        (function () {
            var t = 180 / Math.PI,
                ...
                _ = function (t, s, r, n) {
                    ...
                    if (((o = t.length - 2), 0 > o))
                        return (
                            (c[0] = new a(t[0][s], 0, 0, t[-1 > o ? 0 : 1][s])),
                            c
                        );
                    for (h = 0; o > h; h++)
                        (l = t[h][s]),
                ...
                u = function (t, n, a, h, u, p) {
                    ...
                    for (
                        e.length = i.length = s.length = 0, c = x.length;
                        --c > -1;
                        ...
                        (l = 1),
                            ...
                            (f || b.svg) &&
                                ...
                                b.svg &&
                                    ((C +=
                                        b.xOrigin -
                                        (b.xOrigin * e + b.yOrigin * i)),
                                    (O +=
                                        b.yOrigin -
                                        (b.xOrigin * r + b.yOrigin * n))),
                                m > C && C > -m && (C = x),
                                m > O && O > -m && (O = x),
                                m > D && D > -m && (D = 0)),
                            (T =
                              ...
                              p.rotation || p.skewX || p.svg
                                  ? ((e = p.rotation * z),
                                    ...
                                    p.svg &&
                                        ((m +=
                                            p.xOrigin -
                                            (p.xOrigin * a + p.yOrigin * h)),
                                        (d +=
                                            p.yOrigin -
                                            (p.xOrigin * o + p.yOrigin * l)),
                                        (u = 1e-6),
                                        u > m && m > -u && (m = 0),
                                        u > d && d > -u && (d = 0)),
                                    (_ =
                ...
                (A._updateRoot = D.render =
                    function () {
                        ...
                        if (
                            (I.length && q(),
                            j.render(
                                (a.time - j._startTime) * j._timeScale,
                                !1,
                                !1
                            ),
                            B.render(
                                (a.frame - B._startTime) * B._timeScale,
                                !1,
                                !1
                            ),
                            I.length && q(),
