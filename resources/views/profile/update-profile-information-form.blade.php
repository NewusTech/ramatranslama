<x-jet-form-section submit="updateProfileInformation">
    ...
    <x-slot name="form">
        ...
        <div class="w-md-75">
            ...
            <!-- Whatsapp -->
            {{-- <div class="form-group">
                <x-jet-label for="wa" value="{{ __('Whatsapp') }}" />
                <x-jet-input id="wa" type="text" class="{{ $errors->has('wa') ? 'is-invalid' : '' }}"
                    wire:model.defer="state.wa" autocomplete="wa" />
                <x-jet-input-error for="wa" />
            </div> --}}
