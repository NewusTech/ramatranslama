    ...
    <section class="section">
        ...
        <div class="section-header">
            ...
            <div class="section-header-breadcrumb">
                ...
                <div class="breadcrumb-item">{{ __('Unggulan Layanan') }}</div>
            </div>
                            ...
                            <div class="card-header">
                                <ul class="nav nav-pills w-100 mb-4" role="tablist">
                                    <li class="nav-pill ml-auto">
                                        <a class="nav-link active btn-sm" href="{{ route('data-unggulan') }}"
                                ...
                                <div class="table-responsive">
                                    <table class="table table-striped">
                                        <tr>
                                            ...
                                            <td>
                                                <div>{!! $detailUnggulan->title !!}</div>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td style="font-weight: 700">Keterangan</td>
                                            <td>
                                                <div>{!! $detailUnggulan->desc !!}</div>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td style="font-weight: 700">Created At</td>
                                            <td>
                                                <div>{!! $detailUnggulan->created_at !!}</div>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td style="font-weight: 700">Updated At</td>
                                            <td>
                                                <div>{!! $detailUnggulan->updated_at !!}</div>
                                            </td>
                                        </tr>
                                    </table>
                                </div>
