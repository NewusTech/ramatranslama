        ...
        <section class="section">
            ...
            <div class="section-header">
                ...
                <div class="section-header-breadcrumb">
                    ...
                    <div class="breadcrumb-item"><a href="{{ route('data-tag') }}">{{ __('Tag') }}</a></div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-12">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text"
                                                class="form-control @error('tags.source') is-invalid @enderror"
                                                wire:model="tags.source">
                                            @error('tags.source')
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text"
                                                class="form-control @error('tags.codeTag') is-invalid @enderror"
                                                wire:model="tags.codeTag">
                                            @error('tags.codeTag')
                                            <span class='invalid-feedback'>
                                                <strong>{{ $message }} </strong>
                                            </span>
