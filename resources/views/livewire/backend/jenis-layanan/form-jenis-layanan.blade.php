                                ...
                                <div class="row">
                                    <div class="col-12">
                                        ...
                                        <div class="form-group" wire:ignore>
                                            ...
                                            <textarea class="form-control body @error('jenisLayanan.content') is-invalid @enderror" style="height: 500px"
                                                rows="10" data-model="jenisLayanan.content" wire:model="jenisLayanan.content"> {{ $jenisLayanan ? $jenisLayanan->content : '' }}</textarea>
