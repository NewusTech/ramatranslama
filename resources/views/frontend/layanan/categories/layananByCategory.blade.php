...
<section style="background-color:#040b16" class="breadcrumbs">
    <div class="container">
        <div class="text-left breadcrumbs-item"><a href="{{ route('beranda') }}">home</a>
            <i>/</i><a href="javascript:void(0)" class="last"><span>Detail</span> Layanan</a>
            <h2><span>
                    {{ $jenisLayanan->title }}
                </span> </h2>
        </div>
...
{{-- <div class="content-body">
    <div class="container page">
                        ...
                        <div class="col-md-12">
                            <form method="get" class="form search" action="{{ route('search-layanan') }}">
                                <div class="tours-search">
                                    <div class="col-md-4 col-sm-12" style="padding-left: 0; padding-right: 0">
                                    ...
                                    <div class="col-md-3 col-sm-12" style="padding-left: 0; padding-right: 0">
                                        <div class="selection-box">
                                            <i class="flaticon-suntour-car box-icon"></i>
                                            <select id="jenis_layanan_id" name="jenis_layanan_id" class="">
                                                <option selected disabled>Pilih Jenis Layanan...</option>
                                                @foreach ($jenisLayanan as $itemLayanan)
                                                <option value="{{ $itemLayanan->id }}">
                                                    @foreach ($jenis_l as $item)
                                                    @if ($itemLayanan->id === $item)
                                                    {{ $itemLayanan->title }}
                                                    @endif
                                                    @endforeach
                                                </option>
        ...
        @if($jenisLayanan_all->count())
        <div class="row">
            <div class="col-lg-12 col-md-12 col-12">
                @foreach ($jenisLayanan_all as $layanans)
                <div class="row">
                    <div class="col-lg-4 col-md-5 col-12" id="jadwal-berangkat-hidden">
                        <section class="page-section mb-0 pt-0 pb-20">
                            <div class="cws-widget">
                                <div class="widget-post">
                                    <h2 class="widget-title alt"
                                        style="font-size: 15px; margin: 0 0 8px 0; padding: 13px 0 13px 8px;">
                                        Jadwal {{ $layanans->title}}</h2>
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="bg-gray-3 p-30-40 jadwal-berangkat">
                                                @if ($layanans->jadwal_berangkat > 0)
                                                <p><small style="font-weight: 500;font-size: 14px">{!!
                                                        $layanans->jadwal_berangkat
                                                        !!}</small></p>
                                                @else
                                                <p>
                                                <ul>
                            ...
                            <div class="recom-item-body"><a
                                ...
                                <div class="recom-price">
                                    ...
                                    <span class="font-4">Rp. &nbsp;{{
                                        number_format( $layanans->price, 0, ',','.'); }}
                                    </span>
                                    @else
                                    <span class="font-4">Rp. &nbsp;{{
                                        $layanans->price }}
                                    ...
                                    @endif
                                    &nbsp;
                                    @if ($layanans->isNegotiatable !==1)
                                    <span style="font-size: 13px;font-weight: 600;"><i>(Harga
                                            Negosiasi)</i></span>
                                    @endif
                                </div>
                                <p class="mb-10 mt-5"><i class="flaticon-suntour-car">&ensp;
                                        <a href="{{ route('layananCategoryId', $layanans->jenisLayanan->slug) }}"><strong>{{
                                                $layanans->jenisLayanan->title
                                                }}</strong></a></i>
                                    @if ($layanans->jenis_carter > 0)
                                    <br>
                                    <i class="flaticon-suntour-tag">&ensp;
                                        <a href="#" style="color: #555555; font-size: 14px">{{
                                            $layanans->jenis_carter
                                            }}</a></i>
                                    @else
                                    {{ null }}
                                    @endif
                                ...
                                <a href="{{ route('detail-jasa-transportasi.jasaId', $layanans->slug) }}"
                                    class="recom-button">Selengkapnya...</a><a
                                    ...
                                    class="cws-button small alt" target="_blank">Pesan
                                    Sekarang</a>
                            </div>
                            <!-- Recomended Image-->
                        </div>
    ...
    <div class="container page">
        ...
        <section class="page-section mb-0 pt-0 pb-50">
            <div id="flex-slider" class="flexslider">
                <ul class="slides">
                    <img src="{{Storage::url($jenisLayanan->media)}}" alt="">
                </ul>
            </div>
