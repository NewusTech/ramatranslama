...
@section('content')
    ...
    <section style="background-color:#040b16" class="breadcrumbs">
        <div class="container">
            <div class="text-left breadcrumbs-item"><a href="{{ route('beranda') }}">home</a>
                <i>/</i><a href="javascript:void(0)" class="last"><span>Rute</span></a>
                <h2><span>RUTE</span> </h2>
            </div>
        </div>
    </section>
    <!-- ! breadcrumbs end-->
    ...
    <div class="content-body">
        <div class="container page section-home available-car">
                            ...
                            <div class="col-md-12">
                                <div class="tours-search">
                                    ...
                                    <div class="col-md-3 col-sm-12 newus-filter-rute">
                                        <div class="selection-box">
                                            <i class="flaticon-suntour-map box-icon"></i>
                                            <select id="tujuan" name="tujuan" class="" style="width: 80%">
                                    ...
                                    <div class="col-md-3 col-sm-12 newus-filter-rute">
                                        <div class="selection-box">
                                            ...
                                            <select name="jam" id="jam" class="custom-select"
                                                ...
                                                <option value="08.00" {{ $jam == '08.00' ? 'selected' : '' }}>08.00
                                                </option>
                                                <option value="12.00" {{ $jam == '12.00' ? 'selected' : '' }}>12.00
                                                </option>
                                                <option value="15.00" {{ $jam == '15.00' ? 'selected' : '' }}>15.00
                                                </option>
                                                <option value="17.00" {{ $jam == '17.00' ? 'selected' : '' }}>17.00
                                                </option>
                                                <option value="19.00" {{ $jam == '19.00' ? 'selected' : '' }}>19.00
                                                </option>
                                                <option value="20.00" {{ $jam == '20.00' ? 'selected' : '' }}>20.00
                                                </option>
                                            </select>
